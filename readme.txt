...
LOS TOPOS: ROBUST TOPOLOGICAL OPERATIONS FOR DYNAMIC EXPLICIT SURFACES
===============================================================================

Los Topos is a C-callable library built in C++.  This readme describes:
...
$> mkdir build
$> cmake -H. -Bbuild -DCMAKE_BUILD_TYPE=Release -GNinja
$> cmake --build build
...
The files eltopo.h and eltopo.cpp define the interface for Los Topos.  There are 
...
be used by Los Topos (see eltopo.h for more details).  The function 
