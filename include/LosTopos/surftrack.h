...
#include "LosTopos/dynamicsurface.h"
#include "LosTopos/edgecollapser.h"
#include "LosTopos/edgeflipper.h"
#include "LosTopos/edgesplitter.h"
#include "LosTopos/meshmerger.h"
#include "LosTopos/meshpincher.h"
#include "LosTopos/meshsmoother.h"
...
struct SurfTrackInitializationParameters
{
    ...
    ///
    double m_proximity_epsilon = 1e-4;
    ...
    ///
    double m_min_triangle_area = 1e-2;
    
    /// Whether to enable T1 transition operations
    ///
    bool m_t1_transition_enabled = true;
    
    /// The velocity field callback
    ///
    T1Transition::VelocityFieldCallback * m_velocity_field_callback = nullptr;
