...
#include "LosTopos/common/array3.h"
#include "LosTopos/broadphase.h"
#include <cassert>
#include "LosTopos/common/ccd_wrapper.h"
#include "LosTopos/collisionpipeline.h"
#include "LosTopos/common/collisionqueries.h"
#include "LosTopos/edgeflipper.h"
#include "LosTopos/impactzonesolver.h"
#include "LosTopos/common/lapack_wrapper.h"
#include "LosTopos/nondestructivetrimesh.h"
#include <queue>
#include "LosTopos/common/runstats.h"
#include "LosTopos/subdivisionscheme.h"
#include <stdio.h>
#include "LosTopos/trianglequality.h"
#include "LosTopos/common/vec.h"
#include <vector>
#include "LosTopos/common/wallclocktime.h"
#include <algorithm>
...
//m_min_edge_length( 0.0 ),     // <- Don't allow instantiation without setting these parameters
//m_max_edge_length( 0.0 ),     // <-
m_min_target_edge_length( 0.0 ),   // <- Don't allow instantiation without setting these parameters
m_max_target_edge_length( 0.0 ),   // <-
m_max_volume_change     ( 0.0 ),   // <-
m_refine_solid(true),
...
m_max_volume_change( 0.0 ),
//m_min_edge_length( 0.0 ),
//m_max_edge_length( 0.0 ),
m_min_target_edge_length( 0.0 ),
m_max_target_edge_length( 0.0 ),
...
m_perform_smoothing( initial_parameters.m_perform_smoothing)
{
    ...
    assert( initial_parameters.m_min_target_edge_length );
    assert( initial_parameters.m_max_target_edge_length );
